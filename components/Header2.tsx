        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
          ...
          <div className="flex flex-col items-start space-y-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="border-l border-black h-10 mx-2 hidden md:inline-block"></span>
              <div
              ...
              >
                <Image
                  ...
                  width={64}
                />
                <span className="pl-2 font-semibold lg:text-3xl">
            ...
            <div className="font-serif text-xs sm:text-sm md:text-base text-gray-700 text-center md:text-left">
              ...
              <b className="text-sm sm:text-base md:text-lg">
          ...
          <button
            ...
            className="text-sm sm:text-base md:text-lg flex border border-orange-500 px-4 py-2 bg-orange-600 text-white rounded-md outline-none hover:bg-orange-500 hover:text-white transition-colors"
            style={{
