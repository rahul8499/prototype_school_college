...
const Page = () => {
 ...
 <ToastContainer
      ...
      {isPopupOpen && (
        <div className="fixed inset-0 z-30  flex justify-center items-center  pointer-events-auto  ml-3 mr-3">
      ...
      {chatBotPopupOpen && (
        <div className="fixed inset-0 flex justify-end items-end z-40 p-4 lg:end-16  mb-32 lg:p-0">
          <div className="relative bg-orange-600  lg:h-[520px]  rounded-3xl  shadow-lg w-full sm:w-96">
            <h4 className=" text-center text-2xl font-serif font-bold rounded-xl  text-white bg-orange-600 h-14 p-4">
              Chat with us
            </h4>
            <button
